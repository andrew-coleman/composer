...
describe('IndexCompiler', () => {
    ...
    describe('generate query indexes', () => {
        ...
        it('should generate index for Q12', () => {
            ...
            index.should.equal('{"index":{"fields":["\\\\$class","\\\\$registryType","\\\\$registryId",{"foo":"desc"}]},"name":"Q12","ddoc":"Q12Doc","type":"json"}');
        });

        it('should generate index for Q13', () => {
            const index = indexCompiler.compile(queries.Q13);
            index.should.equal('{"index":{"fields":["\\\\$class","\\\\$registryType","\\\\$registryId",{"foo":"asc"},{"bar":"desc"}]},"name":"Q13","ddoc":"Q13Doc","type":"json"}');
        });
